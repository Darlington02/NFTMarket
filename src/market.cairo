...
from src.interfaces.IERC721 import IERC721
...
// CONSTANTS
const ETH_CONTRACT_GOERLI2 = 0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7;
...
// @dev function to get get the sale status for a listing
...
func buy_token{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    IERC20.transferFrom(ETH_CONTRACT_GOERLI2, buyer, this_contract, listing_price_in_uint);
    ...
    IERC20.transfer(ETH_CONTRACT_GOERLI2, seller, listing_price_in_uint);
